...
|----------|--------|-----------|-------|
| Unit test architecture & structure: ASPICE/ISO 26262/DO-178C requirements, test-to-code mapping, coverage vs. mutation score, tooling for enforcement | **SETTLED** | [2026-07-21_test_architecture_sota.md](deep_dives/2026-07-21_test_architecture_sota.md) | **Test per method is an anti-pattern** (Ian Cooper, Google Testing). **Safety standards** (ASPICE SWE.4, ISO 26262 ASIL C/D, DO-178C DAL A) mandate structural coverage (MC/DC, 100% branch) but NOT test-per-method. **Mutation testing** is emerging as quality metric (70% startup adoption 2025); equivalent mutant problem (4–39%) remains a blocker. **Tooling gap**: No automated enforcement of test-to-code traceability. |

...
from devtools.graph.calls import CallArrows
...
log = logging.getLogger("devtools.graph.archmap")
...
# archviz is package-root DATA (vendored cytoscape/fcose + page shell); resolved via the package, not this
# module's file, so archmap can live in graph/ while the data stays at the root (bd 5hg).

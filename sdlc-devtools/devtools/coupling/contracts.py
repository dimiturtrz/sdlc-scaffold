...
from devtools.graph.arrows import HOLDS, INHERITS, REFERENCES, ClassArrows
from devtools.graph.calls import CALLS, CONSTRUCT, CallArrows
...
log = logging.getLogger("devtools.coupling.contracts")
